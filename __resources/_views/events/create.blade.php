                ...
                <!-- Panel -->
                    <form autocomplete="off" role="form"  class="te-ajax-form" action="events/ajax_save_event" id="Events_form">
                        ...
                        <div class="form-group form-material">
                            ...
                            <input style="width: 200px;" type="text" class="form-control" id="date_picker" name="event_date" placeholder="Event Date" value="<?php echo isset($event['event_date']) ? date('Y-m-d', strtotime($event['event_date'])) : date('d-m-Y', time()) ?>" />
                        </div>
