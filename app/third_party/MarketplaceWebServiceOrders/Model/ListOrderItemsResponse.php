 ...
 class MarketplaceWebServiceOrders_Model_ListOrderItemsResponse extends MarketplaceWebServiceOrders_Model {
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
			...
			//return NULL;
			//echo $xml;exit;
            throw new Exception ("Unable to construct MarketplaceWebServiceOrders_Model_ListOrderItemsResponse from provided XML.                     Make sure that ListOrderItemsResponse is a root element");
        }
    }
    /**
