 ...
 ***********************************************************************/
 ...
 $request->setCreatedAfter( '2010-01-01' );
			...
			$request = new MarketplaceWebServiceOrders_Model_ListOrderItemsRequest();
			 ...
			 foreach($orderItems as $item) {
                ...
                <tr>
                    ...
                    <td><?php echo $order->getAmazonOrderId();?></td>
                    <td><?php echo $item->getSellerSKU();?></td>
					...
					if($price) { 
						...
						echo $price->getAmount(); echo $price->getCurrencyCode();
					
					}
					?></td>
                    <td><?php echo $order->getPurchaseDate();?></td>
                </tr>
                <?php
ob_flush();
        flush();		 
