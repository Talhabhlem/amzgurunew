...
<div class="table-responsive">
	<h2 style="color: #62a8ea;"><?php echo SITE_NAME.' '.$package.' Alert'; ?></h2>
	<div id="sales_table_pagination" style="margin-bottom:10px;">
    <div style="float:right;font-size:13px; color:#333;">(<strong><?php echo $date_interval;?></strong>)</div>
</div>
...
<!--                </td>-->
				...
				?>
                <td style="text-align:center; font-weight: bold; border-left: 1px solid #e4eaec;font-size: 24px; color:<?php echo $sale_status=='-' ? '#ff0000':'#00ff00';?>;"  class="center-text status-box <?php echo $sale_status=='-' ? 'minus':'plus';?>"><?php echo $sale_status;?></td>
                
<!--                <td style=font-weight: normal; border-left: 1px solid #e4eaec;font-size: 13px; class="center-text">-->
<!--                    --><?php //
//					$percent = $sale['price_percentage']*100;
//					echo number_format($percent,2,'.','').'%';?>
<!--                </td>-->
				...
				?>
                <td style="text-align:center; font-weight: bold; border-left: 1px solid #e4eaec;font-size: 24px; color:<?php echo $profit_status=='-' ? '#ff0000':'#00ff00';?>;"  class="center-text status-box  <?php echo $profit_status=='-' ? 'minus':'plus';?>"><?php echo $profit_status;?></td>
            ...
            <tr>
                <th style="background:#62a8ea !important; color:#FFF;  font-weight: bold; font-size: 16px; border-left: 1px solid #e4eaec; border-bottom: 1px solid #e4eaec;" colspan="2" style="text-align:right;">Total Unit Items Sold
                    ...
                    ?>
                    (<span class="<?php echo $total_units_status=='-' ? 'minus':'plus';?>"><?php echo $total_units_status;?></span>)
                </th>
                <th style="background:#62a8ea !important; color:#FFF;  font-weight: bold; font-size: 16px; border-left: 1px solid #e4eaec; border-bottom: 1px solid #e4eaec;""><?php echo $tl_u;?></th>
                <th style="background:#62a8ea !important; color:#FFF;  font-weight: bold; font-size: 16px; border-left: 1px solid #e4eaec; border-bottom: 1px solid #e4eaec;""><?php echo $t_u;?></th>
                ...
                <th style="background:#62a8ea !important; color:#FFF;  font-weight: bold; font-size: 16px; border-left: 1px solid #e4eaec; border-bottom: 1px solid #e4eaec;">Total Sale Amount
                    ...
                    ?>
                    (<span class="<?php echo $total_sale_status=='-' ? 'minus':'plus';?>"><?php echo $total_sale_status;?></span>)
                </th>
                <th style="background:#62a8ea !important; color:#FFF;  font-weight: bold; font-size: 16px; border-left: 1px solid #e4eaec; border-bottom: 1px solid #e4eaec;""><?php echo '$'.number_format($tl_s,2);?></th>
                <th style="background:#62a8ea !important; color:#FFF;  font-weight: bold; font-size: 16px; border-left: 1px solid #e4eaec; border-bottom: 1px solid #e4eaec;""><?php echo '$'.number_format($t_s,2);?></th>
                ...
                <th style="background:#62a8ea !important; color:#FFF;  font-weight: bold; font-size: 16px; border-left: 1px solid #e4eaec; border-bottom: 1px solid #e4eaec;" >Total Profit
                    ...
                    ?>
                    (<span class="<?php echo $total_profit_status=='-' ? 'minus':'plus';?>"><?php echo $total_profit_status;?></span>)
                </th>
                <th style="background:#62a8ea !important; color:#FFF;  font-weight: bold; font-size: 16px; border-left: 1px solid #e4eaec; border-bottom: 1px solid #e4eaec;""><?php echo '$'.number_format($tl_p,2);?></th>
                <th style="background:#62a8ea !important; color:#FFF;  font-weight: bold; font-size: 16px; border-left: 1px solid #e4eaec; border-bottom: 1px solid #e4eaec;"" colspan="2"><?php echo '$'.number_format($t_p,2);?></th>
