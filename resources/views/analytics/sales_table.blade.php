                    ...
                    <div class="btn-group" role="group">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="exampleIconDropdown4" role="menu">
                            <li role="presentation">
                                <a role="menuitem" title="Daily Sales" data-toggle="modal"  href="#modalSalesAnalysis" data-target="#modalSalesAnalysis" data-title="{{substr($sale->title,0,50)}}" data-sku="<?php echo $sale->sku;?>" data-chart-type="daily"  >Daily Analysis</a>
                            </li>
                            <li role="presentation">
                                <a role="menuitem" title="Daily Sales" data-toggle="modal"  href="#modalSalesAnalysis" data-target="#modalSalesAnalysis" data-title="{{substr($sale->title,0,50)}}" data-sku="<?php echo $sale->sku;?>" data-chart-type="weekly"  >Weekly Analysis</a>
                            </li>
                        </ul>
                    </div>
                </td>
