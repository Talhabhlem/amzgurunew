...
{{--@section('title', 'Analysis - AMZ Guru') --}}
@section('title')
@endsection
...
@section('scripts')
    ...
    <!-- Modal -->
    <div class="modal modal-primary fade modal-3d-flip-vertical"  id="modalSalesAnalysis" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            jQuery('#modalSalesAnalysis').on('shown.bs.modal', function (e) {
                ...
                var chartType = thisClickedButton.data('chart-type');
                var sku = thisClickedButton.data('sku');
                var title = thisClickedButton.data('title');
                if(chartType == 'daily') {
                ...
                if(sku!='ALL_SKU')
                {
                    $('h4.modal-title').append('<p style="font-weight: normal; font-size: 16px;">Sku: '+sku+'</p>');
                    $('h4.modal-title').append('<p style="font-weight: normal; font-size: 16px;">Title: '+title+'</p>');
                }
                else
                {
                    $('h4.modal-title').append('<p style="font-weight: normal; font-size: 16px;">Sku: All</p>');
                }
            });
